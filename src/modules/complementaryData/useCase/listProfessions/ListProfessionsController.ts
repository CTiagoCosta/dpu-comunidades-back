...
export class ListProfessionsController extends BaseController {
  constructor(private complementaryDataServices: ComplementaryDataServices) {
    super("Ocorreu um erro ao listar as profissões");
  }
  ...
  protected async specificImplementation(
    ...
    const result = await this.complementaryDataServices.listProfessions();

    return HandleResponse.success(result, "Sucesso ao listar profissões");
  }
}
